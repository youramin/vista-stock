    ...
    <div class="mt-16 z-0 mb-8">
        <div class="flex p-1 w-full">
            ...
            @canany(['isAdmin', 'isMedia', 'isMarketing'])
                <div class="border-b">
                    <a href="/dashboard/products/create" class="index-link btn-primary">
            ...
            <table class="table-auto w-full">
                <thead>
                    <tr class="bg-teal-100 h-10">
                        ...
                        <th class="text-teal-700 border text-sm text-center w-25">Nama Barang</th>
                        <th class="text-teal-700 border text-sm text-center">Kategori</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-teal-700 border text-sm text-center">{{ $product->code }}</td>
                        <td class="text-teal-700 border text-sm text-center">{{ $product->name }}</td>
                        <td class="text-teal-700 border text-sm text-center">{{ $product->category->name }}</td>
                        <td class="text-teal-700 border text-sm text-center">{{ $product->description }}</td>
                                ...
                                @canany(['isAdmin', 'isMedia', 'isMarketing'])
                                    ...
                                    <form action="/dashboard/products/{{ $product->id }}"
                                        ...
                                        <button
                                            ...
                                            onclick="return confirm('Apakah anda yakin ingin menghapus {{ $product->name }} dengan kode {{ $product->code }} ?')">
                                            <svg class="fill-current w-[18px] 2xl:w-5" clip-rule="evenodd"
                                                fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2"
                                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                <path
