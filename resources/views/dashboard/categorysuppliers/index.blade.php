            ...
            @canany(['isAdmin', 'isMedia', 'isMarketing'])
                <div class="border-b">
                    <a href="/dashboard/categorysuppliers/create" class="index-link btn-primary">
                        ...
                        <span class="mx-1 hidden sm:flex">Tambah Kategori</span>
                    </a>
                </div>
            @endcanany
        </div>
                    ...
                    <tr>
                        ...
                        <td class="text-teal-700 border text-sm text-center">
                            <div class="flex justify-center items-center">
                                ...
                                @canany(['isAdmin', 'isMedia', 'isMarketing'])
                                    <a href="/dashboard/categories/{{ $categorysupplier->id }}/edit"
                                    ...
                                    <form action="/dashboard/categories/{{ $categorysupplier->id }}"
