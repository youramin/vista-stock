    ...
    <div class="mt-10 z-0 mb-8">
        <div class="flex p-1 w-full">
            ...
            @canany(['isAdmin', 'isMedia', 'isMarketing'])
                <div class="border-b">
                    <a href="/dashboard/warehouses/create" class="index-link btn-primary">
                        ...
                        <span class="mx-1 hidden sm:flex">Tambah Gudang</span>
                    </a>
                </div>
            @endcanany
        </div>
        <div class="">
            <form action="/dashboard/warehouses">
            ...
            <table class="table-auto w-full">
                <thead>
                    <tr class="bg-teal-100 h-10">
                        ...
                        <th class="text-teal-700 border text-sm w-24 text-center">Kode Gudang</th>
                        <th class="text-teal-700 border text-sm text-center w-25">Nama Gudang</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-teal-700 border text-sm text-center">{{ $warehouse->code }}</td>
                        <td class="text-teal-700 border text-sm text-center">{{ $warehouse->name }}</td>
                        <td class="text-teal-700 border text-sm text-center">{{ $warehouse->description }}</td>
                        <td class="text-teal-700 border text-sm text-center">
                            <div class="flex justify-center items-center">
                                <a href="/dashboard/warehouses/{{ $warehouse->id }}"
                                ...
                                @canany(['isAdmin', 'isMedia', 'isMarketing'])
                                    ...
                                    <form action="/dashboard/warehouses/{{ $warehouse->id }}"
                                        ...
                                        <button
                                            ...
                                            onclick="return confirm('Apakah anda yakin ingin menghapus {{ $warehouse->name }} dengan kode {{ $warehouse->code }} ?')">
                                            <svg class="fill-current w-[18px] 2xl:w-5" clip-rule="evenodd"
                                                fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2"
                                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                <path
